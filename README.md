...
| **Pakistan Crop Price Forecasting** | End-to-end time-series forecasting and anomaly detection on 53 CSVs | Python, Pandas, Scikit-learn | 9 models benchmarked; Linear Regression ranked first by RMSE; lag_1 identified as dominant universal predictor |
...
| **E-Commerce Data Warehouse** | Reporting and analytics solution for business insights | PostgreSQL, Power BI | Star schema design, ETL from raw transactional data, Power BI dashboards |
